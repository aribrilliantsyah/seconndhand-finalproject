...
router.get(`/product/public/:id`, Middleware.checkProfile, ctl.findByID)
...
router.post(`/product/upload-pics/`, upload.array('pictures', 4), Middleware.verifyJwt, Middleware.checkProfile, ctl.uploadPics, (error, req, res, next) => {
